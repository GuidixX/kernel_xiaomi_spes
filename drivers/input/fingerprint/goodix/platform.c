...
static int gf_pinctrl_init(struct gf_dev *gf_dev)
{
	...
	gf_dev->gf_pwr_high = pinctrl_lookup_state(gf_dev->pinctrl_gpios,
			"goodix_pwr_outputhigh");
	...
	gf_dev->gf_pwr_low = pinctrl_lookup_state(gf_dev->pinctrl_gpios,
			"goodix_pwr_outputlow");
	...
	gf_dev->gf_reset_high = pinctrl_lookup_state(gf_dev->pinctrl_gpios,
			"goodix_reset_outputhigh");
	...
	gf_dev->gf_reset_low = pinctrl_lookup_state(gf_dev->pinctrl_gpios,
			"goodix_reset_outputlow");
