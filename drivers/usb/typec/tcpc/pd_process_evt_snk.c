...
static bool pd_process_ctrl_msg_get_source_cap(struct pd_port *pd_port, uint8_t next)
{
...
static inline bool pd_process_hw_msg_sink_tx_change(struct pd_port *pd_port, struct pd_event *pd_event)
{
