...
static int sc8551_enable_wdt(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_0B, SC8551_WATCHDOG_DIS_MASK, val);
...
static int sc8551_set_wdt(struct sc8551 *sc, int ms)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_0B, SC8551_WATCHDOG_MASK, val);
...
static int sc8551_set_reg_reset(struct sc8551 *sc)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_0B, SC8551_REG_RST_MASK, val);
...
static int sc8551_enable_batovp(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_00, SC8551_BAT_OVP_DIS_MASK, val);
...
static int sc8551_set_batovp_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_00, SC8551_BAT_OVP_MASK, val);
...
static int sc8551_enable_batovp_alarm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_01, SC8551_BAT_OVP_ALM_DIS_MASK, val);
...
static int sc8551_set_batovp_alarm_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_01, SC8551_BAT_OVP_ALM_MASK, val);
...
static int sc8551_enable_batocp(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_02, SC8551_BAT_OCP_DIS_MASK, val);
...
static int sc8551_set_batocp_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_02, SC8551_BAT_OCP_MASK, val);
...
static int sc8551_enable_batocp_alarm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_03, SC8551_BAT_OCP_ALM_DIS_MASK, val);
...
static int sc8551_set_batocp_alarm_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_03, SC8551_BAT_OCP_ALM_MASK, val);
...
static int sc8551_set_busovp_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_06, SC8551_BUS_OVP_MASK, val);
...
static int sc8551_enable_busovp_alarm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_07, SC8551_BUS_OVP_ALM_DIS_MASK, val);
...
static int sc8551_set_busovp_alarm_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_07, SC8551_BUS_OVP_ALM_MASK, val);
...
static int sc8551_enable_busocp(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_08, SC8551_BUS_OCP_DIS_MASK, val);
...
static int sc8551_set_busocp_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_08, SC8551_BUS_OCP_MASK, val);
...
static int sc8551_enable_busocp_alarm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_09, SC8551_BUS_OCP_ALM_DIS_MASK, val);
...
static int sc8551_set_busocp_alarm_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_09, SC8551_BUS_OCP_ALM_MASK, val);
...
static int sc8551_enable_batucp_alarm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_04, SC8551_BAT_UCP_ALM_DIS_MASK, val);
...
static int sc8551_set_batucp_alarm_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_04, SC8551_BAT_UCP_ALM_MASK, val);
...
static int sc8551_set_acovp_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_05, SC8551_AC_OVP_MASK, val);
...
static int sc8551_set_vdrop_th(struct sc8551 *sc, int threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_05, SC8551_VDROP_THRESHOLD_SET_MASK, val);
...
static int sc8551_set_vdrop_deglitch(struct sc8551 *sc, int us)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_05, SC8551_VDROP_DEGLITCH_SET_MASK, val);
...
static int sc8551_enable_bat_therm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_0C, SC8551_TSBAT_DIS_MASK, val);
...
static int sc8551_enable_bus_therm(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_0C, SC8551_TSBUS_DIS_MASK, val);
...
static int sc8551_set_die_therm_th(struct sc8551 *sc, u8 threshold)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2A, SC8551_TDIE_ALM_MASK, val);
...
static int sc8551_enable_adc(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_14, SC8551_ADC_EN_MASK, val);
...
static int sc8551_set_sense_resistor(struct sc8551 *sc, int r_mohm)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2B, SC8551_SET_IBAT_SNS_RES_MASK, val);
...
static int sc8551_enable_regulation(struct sc8551 *sc, bool enable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2B, SC8551_EN_REGULATION_MASK, val);
	return ret;
}
...
static int sc8551_set_ss_timeout(struct sc8551 *sc, int timeout)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2B, SC8551_SS_TIMEOUT_SET_MASK, val);
...
static int sc8551_set_ibat_reg_th(struct sc8551 *sc, int th_ma)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2C, SC8551_IBAT_REG_MASK, val);
...
static int sc8551_set_vbat_reg_th(struct sc8551 *sc, int th_mv)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_2C, SC8551_VBAT_REG_MASK, val);
...
static int sc8551_get_work_mode(struct sc8551 *sc, int *mode)
{
	...
	sc_info("work mode: %s\n", *mode == SC8551_ROLE_STDALONE ? "Standalone" : (*mode == SC8551_ROLE_SLAVE ? "Slave" : "Master"));
	return ret;
}
#endif
...
static int sc8551_detect_device(struct sc8551 *sc)
{
	...
	pr_info("sc8551_detect_device: PART_INFO: 0x%x", data);
	return ret;
}
...
static int sc8551_disable_vbus_range(struct sc8551 *sc, bool disable)
{
	...
	ret = sc8551_update_bits(sc, SC8551_REG_35, SC8551_VBUS_RANGE_DIS_MASK, val);
